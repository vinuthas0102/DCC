              ...
              return (
                ...
                >
                  <td className="py-1.5 px-3">
                    <div className="text-xs font-semibold text-slate-900 truncate max-w-[200px]">{group.objectDescription || group.objectRef}</div>
        ...
        <div className="flex items-start gap-3 px-4 py-3 bg-blue-800 border-b border-blue-900 shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 text-[10px] text-slate-300 mb-0.5">
              ...
              <span className="font-bold text-white">Object Summary</span>
            </div>
